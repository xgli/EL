...
cmn_es_find_dict = {}
filter_for_research_file = open('../data/dict/cmn_nominal.tab', 'r')#词表
fw = open('../data/result/cmn/cmn_nominal.tab', 'w')
...
pickle.dump(cmn_es_find_dict,file("cmn_es_found_nom.pk","wb"))
pickle.dump(cmn_author_and_pinyin_found_dict, file('cmn_es_found_loc_nom.pk', 'wb'))

...
cmn_es_find_dict = {}
filter_for_research_file = open('../dict/cmn_add_pinyin.dict', 'r')#词表
...
filter_for_research_file = open('../dict/eng_add.dict', 'r')
...
filter_for_research_file = open('../dict/spa_add.dict', 'r')
